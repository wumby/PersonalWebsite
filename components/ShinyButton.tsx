...
const ShinyButton = (props: ShinyButtonProps) => {
    return (
      ...
      {!!props.href && (
        ...
        <button className={`relative inline-flex  h-12 overflow-hidden rounded-lg p-[1px] focus:outline-none md:w-60 cursor-pointer ${props.classes}`} onClick={props.handleClick}>
