...
const ShinyButton = (props: ShinyButtonProps) => {
    return (
      ...
      {!!props.href && (
        ...
        <button className={`relative inline-flex h-12 overflow-hidden rounded-lg p-[1px] focus:outline-none md:w-60 md:mt-10 cursor-pointer ${props.classes}`} onClick={props.handleClick}>
