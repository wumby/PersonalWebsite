...
const Contact = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center text-sm md:text-lg xl:text-xl pt-8 mb-8">
        Reach Out and Connect – I’m Always Open to New Ideas!
      </div>
      ...
      <div className="flex justify-center items-center overflow-visible">
        ...
        <div className="mx-10 flex justify-center items-center h-[8vh]">
          <ShinyButton
            text={copied ? "Email is Copied!" : "Copy my email"}
            icon={<FaCopy />}
        ...
        <LinkPreview
          url={"https://www.linkedin.com/in/jack-ziegler-350447176/"}
          imageSrc={"/jack.png"}
          isStatic
        >
          <Button
